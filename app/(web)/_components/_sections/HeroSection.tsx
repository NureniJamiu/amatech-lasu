  ...
  return (
    <div className='text-center'>
      <div className='pt-5 px-5'>
        ...
        <h2 className={`${textGradient} text-[25px] md:w-[700px] mx-auto md:text-4xl lg:text-5xl font-bold leading-snug mt-10 bg-gradient-to-r py-3 '`}>Welcome to the Department of Management Technology</h2>
