...
const TitleHero = ({ title }: { title: React.ReactNode }) => {
  return (
    <div className="bg-gradient-to-l from-green-700 to-green-600 h-60 md:h-72 w-full px-8 md:px-24">
      <div className="flex flex-col justify-center max-w-7xl h-full mx-auto">
